...
def checkout():
    ...
    return render_template("checkout.html", fname_template=first_name, lname_template=last_name, studentid=student_id, strawberry_amt=strawberry_amt, raspberry_amt=raspberry_amt, apple_amt=apple_amt, blackberry_amt=blackberry_amt,
                           count=count, utc_dt=datetime.datetime.utcnow())
